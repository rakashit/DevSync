...
import { Code2, GitMerge, MessageSquareCode, UserCircle2 } from 'lucide-react';
          ...
          <Card className="shadow-2xl border-white/20 dark:border-white/10 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl">
            ...
            <CardContent className="pb-8">
              <div className="space-y-5">
                ...
                <Button
                  variant="outline"
                  className="w-full h-12 text-base font-semibold transition-all hover:scale-[1.02] active:scale-[0.98] shadow-sm"
